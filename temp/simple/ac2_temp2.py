"""
From the book 'Handson Reinforcement Learning for Games', Chapter 8, p.185
"""
...
class ActorCritic(nn.Module):
    ...
    def make_batch(self):
        ...
        for transition in self.data:
            ...
            s_lst.append(s)
            a_lst.append([a])
            r_lst.append([r/100.0]) # !! normalize rewards
        ...
        self.data = [] # !! clean out self.data after batch generation
    ...
    while not done:
        for t in range(n_rollout):
            ...
            if iteration % print_interval == 0 and iteration != 0:
                print(f"# of episode : {iteration}, avg score : {score/print_interval}")
                score = 0.0
env.close()
